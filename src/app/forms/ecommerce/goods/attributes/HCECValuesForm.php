...
namespace interactivesolutions\honeycombecommercegoods\app\forms\ecommerce\goods\attributes;
...
{
    // name of the form
    protected $formID = 'e-commerce-goods-attributes-values';
    ...
    {
        $form = [
            'storageURL' => route('admin.api.routes.e.commerce.goods.attributes.values'),
            'buttons'    => [
                [
                    "class" => "col-centered",
            ...
            'structure'  => [
                [
                    ...
                    "label"           => trans("HCECommerceGoods::e_commerce_goods_attributes.type_id"),
                    "required"        => 1,
                    "requiredVisible" => 1,
                    ...
                    "dependencies"    => [
                        [
                            "field_id"    => "type_id",
                            "options_url" => route('admin.api.e.commerce.goods.attributes.list') . '?dynamic=0',
                        ],
                    ],
                ], [
                    "type"            => "singleLine",
