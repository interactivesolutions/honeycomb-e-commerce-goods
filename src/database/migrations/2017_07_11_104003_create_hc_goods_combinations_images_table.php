...
class CreateHcGoodsCombinationsImagesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('hc_goods_combinations_images', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('hc_goods_combinations_images');
    }
}
